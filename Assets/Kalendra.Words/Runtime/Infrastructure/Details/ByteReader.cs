...
namespace Kalendra.Words.Runtime.Infrastructure.Details
{
	/// <summary>
	...
	internal class ByteReader
	{
		...
		public ByteReader(byte[] bytes, char separator = ';')
		{
			mBuffer = bytes;
			mSeparator = separator;
		}

		public ByteReader(TextAsset asset, char separator = ';')
		{
			mBuffer = asset.bytes;
			mSeparator = separator;
		}
		...
		static readonly List<string> mTemp = new List<string>();

		/// <summary>
		/// Read a single line of <see cref="mSeparator"/>-Separated Values from the file.
		/// </summary>
